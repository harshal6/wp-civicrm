...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://db:db@db/db?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['wp.frontend.base']['url'] = 'http://wp-civicrm.ddev.site:8000/';
$civicrm_paths['wp.backend.base']['url'] = 'http://wp-civicrm.ddev.site:8000/wp-admin/';
$civicrm_setting['URL Preferences']['userFrameworkResourceURL'] = 'http://wp-civicrm.ddev.site:8000/wp-content/plugins/civicrm/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://db:db@db:3306/db?new_link=true');
  }
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://wp-civicrm.ddev.site:8000/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '4daf806fb2f326fe256c27599dc658cc');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/html/wp-content/uploads/civicrm/templates_c//mail.log');
// }
